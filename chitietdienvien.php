...
<div class="than">
    <div class="leftthan">
        <div class="top">
            <div class="left">
                    <img src="admin/img/<?=$row_dv['Anh_DV']?>"/>
            </div>
                <div class="right">
                        <p>Tên diễn viên: <?=$row_dv['TenDienVien']?></p>
                        <p>Ngày sinh: <?=$row_dv['NgaySinh']?></p>
                        <p>Nơi sinh: <?=$row_dv['NoiSinh']?></p>
                        <p>Quốc tịch: <?=$row_qt['TenQuocTich']?></p>
                        <p>Chiều cao: <?=$row_dv['ChieuCao']?></p>
                        <p>Cân nặng: <?=$row_dv['CanNang']?></p>
                        <p>Nghề nghiệp: <?=$row_nn['TenNgheNghiep']?></p>
                        <p>Hoạt động: <?=$row_dv['HoatDong']?></p>
                </div>
        </div>
        <div class="mid1">
            <a href="phimcuadv.php?ID=<?=$row_dv['ID_DienVien']?>">Xem phim của <?=$row_dv['TenDienVien']?></a>
        </div>
        <div class="mid2">
            <h1>Tiểu sử</h1>
            <p><?=$row_dv['MoTa']?></p>
