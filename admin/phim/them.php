<?php
    ...
    if(isset($_POST['sbm']))
    {
        ...
        $sql = "INSERT INTO phim (TenPhim, Anh, ThoiLuong, SoTap, PhimLe, QuocGia, NamSanXuat, NgayCongChieu, TheLoai, DaoDien, DienVien, DienVien2, Video, LuotXem, MoTa)
        VALUES ('$TenPhim', '$Anh', '$ThoiLuong', '$SoTap', '$PhimLe', '$QuocGia', '$NamSanXuat', '$NgayCongChieu', '$TheLoai', '$DaoDien', '$DienVien', '$DienVien2', '$Video', '$LuotXem', '$MoTa')";
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ThoiLuong" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="NamSanXuat" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="">Ngày công chiếu</label>
                    <input type="date" name="NgayCongChieu" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="LuotXem" class="form-control" required>
                </div>
                <div class="form-group">
