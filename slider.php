...
<h1 style="font-size: 30px; color: #f3ff50fd; margin-top: 25px;">Phim mới nhất</h1>

<div class="owl-carousel">
  <?php
    $sql = "SELECT * FROM phim ORDER BY NgayCongchieu desc limit 10";
  ...
  <div class="mott">
    ...
    <div><a style="color: White; font-size: 14px; text-decoration:none;" href="theloai_phim.php?ID=<?=$theloai['ID_TheLoai']?>"><?=$theloai['TenTheLoai']?></a></div>
